                ...
                <ul class="row">
                  <li class="col-1-3">
                    <article class="card-testimonial">
                      ...
                      <blockquote class="card-quote">
                        <p>I am completely blown away. Thanks to Techium, we have just launched our 5th website!
                          <cite>Yuri Y.</cite>
                        </p>
                      </blockquote>
                    </article>
                  ...
                  <li class="col-1-3">
                    <article class="card-testimonial">
                      ...
                      <blockquote class="card-quote">
                        <p>I love your system. Definitely worth the investment. I would be lost without Techium company.
                          <cite>Sven H.</cite>
                        </p>
                      </blockquote>
                    </article>
